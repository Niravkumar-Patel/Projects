...
public class ConstructDictionary extends DefaultHandler {
	...
	public void constructDictionary(){
    	...
    	try {			
			...
			fileWriter = new FileWriter("C:\\Users\\Niravkumar\\Documents\\SanJose\\CS286_AkashNanavati\\Assignment2\\Assig2_Stage1.txt");			
...
//        	   }
    ...
    public void writePageListToFile(){
		try {				
			bw.write(pageTitle+"-Title-"+pageID+"-Page-ID-"+tsDictionary.toString()+"-E-O-C-");
			bw.write("\n");
			bw.flush();
			tsDictionary.clear();
		} catch (IOException e) {
