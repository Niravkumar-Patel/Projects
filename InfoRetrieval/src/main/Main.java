...
import queryProcessing.SearchService;
...
import searchEngine.postingList.GeneratePostingList;
import searchEngine.postingList.RefiningDictionaryList;
...
//		cd.constructDictionary();
		...
		RefiningDictionaryList pl = new RefiningDictionaryList();
		//pl.constructPostingList();
		
		GeneratePostingList gpl = new GeneratePostingList();
//		gpl.constructPostingList();
...
//		s4.refineStage3Output();
	...
	/*	 Please uncomment below code for debugging
	 * 
	...
	/*	try
		...
		/*String[] pageTitleArray = new String[10873965];//177592    10873965
		Integer[] pageIDArray = new Integer[10873965];//177592   
		...
		/*while(true){
				...
				try{
					...
					System.out.println("PageID:"+i+": PageTitle:"+pageTitleArray[Arrays.binarySearch(pageIDArray, i)]);
